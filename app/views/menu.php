...
<div id="home">
    <div class="content-inner">
        ...
        <div class="uk-child-width-1-3@m" id="passo-2" uk-grid>
            <div>
                <div class="uk-card uk-card-default">
                    <div class="uk-card-media-top">
                        <img class="cover" src="public/img/comeraqui.jfif" alt="">
        ...
        <div class="uk-child-width-1-3@m" id="passo-3" uk-grid>
            <div>
                <div class="uk-card uk-card-default">
                    <div class="uk-card-media-top">
                        <img class="cover" src="public/img/comeraqui.jfif" alt="">
...
<script type="text/javascript">
    document.getElementById("passo-2").style.visibility = "hidden";
    document.getElementById("passo-3").style.visibility = "hidden";
    document.getElementById("passo-4").style.visibility = "hidden";

    document.getElementById("comeraqui").addEventListener("click",(e) => {
        console.log("oi")
        document.getElementById("passo-2").style.visibility = "visible";
        document.getElementById("passo-1").style.visibility = "hidden";
    });
</script>
